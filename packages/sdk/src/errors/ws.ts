...
export const WsErrors = {
  WS_COMMENT_NOT_FOUND: {
    code: "WS.COMMENT.NOT_FOUND",
    status: 404,
    message: "Comment not found",
  },
  WS_DASHBOARD_WIDGET_NOT_FOUND: {
    code: "WS.DASHBOARD_WIDGET.NOT_FOUND",
    status: 404,
  ...
  WS_TASK_ACTOR_NOT_FOUND: {
    code: "WS.TASK_ACTOR.NOT_FOUND",
    status: 404,
    message: "Task actor not found",
  },
  ...
  WS_TASK_CONSTRAINT_NOT_FOUND: {
    code: "WS.TASK_CONSTRAINT.NOT_FOUND",
    status: 404,
    message: "Constraint not found",
  },
  WS_TASK_EVENT_LINK_NOT_FOUND: {
    code: "WS.TASK_EVENT_LINK.NOT_FOUND",
    status: 404,
  ...
  WS_WORKSPACE_INVITE_NOT_FOUND: {
    code: "WS.WORKSPACE_INVITE.NOT_FOUND",
    status: 404,
