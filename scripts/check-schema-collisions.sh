...
ALLOWLIST_PATTERN='^(AuthTokens|AutoActionSettingsBody|CalendarResponse|EventResponse|ImportJobBody|IntakeItem|Label|ListTimelineOutputBody|MeBody|OIDCStartOutputBody|PageDTO|Project|PublicShareResponse|SavedLens|Task|TaskComment|TimeboxDTO|WidgetDTO|Workspace|WorkspaceMember)$'
