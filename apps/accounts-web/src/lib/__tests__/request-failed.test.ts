 ...
 * refused.
 *
 * The rule lives in the shared SDK because both web apps depend on it;
 * this case is kept here so a change to it fails in the app that a
 * mis-read refusal would lock someone out of.
 */

import { requestFailed } from '@nodate-flow/sdk';
