// Command dump-openapi builds the nodate-time HTTP router with stub
...
func main() {
	out := flag.String("o", "packages/time-sdk/openapi.json", "output path for the merged OpenAPI JSON document")
	flag.Parse()
