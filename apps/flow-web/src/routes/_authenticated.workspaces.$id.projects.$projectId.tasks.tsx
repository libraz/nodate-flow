/**
 * /workspaces/$id/projects/$projectId/tasks — route stub.
 * See sibling `.lazy.tsx`.
 *
...
export const Route = createFileRoute('/_authenticated/workspaces/$id/projects/$projectId/tasks')({
