  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gray-50 px-4">
      <div className="w-full max-w-sm">
        <h1 className="mb-2 text-center text-2xl font-bold text-gray-900">Create your workspace</h1>
        <p className="mb-8 text-center text-sm text-gray-500">
          A workspace is where you and your team organize calendars.
        </p>
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input
              ...
              placeholder="my-team"
            />
            <p className="mt-1 text-xs text-gray-400">Used in URLs to identify your workspace</p>
          </div>
          <button
            type="submit"
