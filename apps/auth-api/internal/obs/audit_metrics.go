...
// action that left no trace. This service owns identity, so the actions
// that go missing here are logins, session revocations, and role
// changes: any sustained value means the identity audit trail is
