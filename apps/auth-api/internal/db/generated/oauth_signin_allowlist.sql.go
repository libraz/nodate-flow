...
// versions:
//   sqlc v1.30.0
// source: oauth_signin_allowlist.sql
...
const findOauthSigninAllowlistEntry = `-- name: FindOauthSigninAllowlistEntry :one
SELECT
  a.public_id,
  a.entry_kind,
  a.entry_value,
...
type FindOauthSigninAllowlistEntryRow struct {
	PublicID           types.PublicID                `json:"publicId"`
	EntryKind          OauthSigninAllowlistEntryKind `json:"entryKind"`
	EntryValue         string                        `json:"entryValue"`
	Notes              sql.NullString                `json:"notes"`
	Enabled            bool                          `json:"enabled"`
	AddedByPublicID    types.PublicID                `json:"addedByPublicId"`
	AddedByDisplayName sql.NullString                `json:"addedByDisplayName"`
...
func (q *Queries) FindOauthSigninAllowlistEntry(ctx context.Context, publicID types.PublicID) (FindOauthSigninAllowlistEntryRow, error) {
	row := q.db.QueryRowContext(ctx, findOauthSigninAllowlistEntry, publicID)
	var i FindOauthSigninAllowlistEntryRow
	err := row.Scan(
		&i.PublicID,
		&i.EntryKind,
		&i.EntryValue,
...
const listEnabledOauthSigninAllowlistEntries = `-- name: ListEnabledOauthSigninAllowlistEntries :many
...
type ListEnabledOauthSigninAllowlistEntriesRow struct {
	EntryKind  OauthSigninAllowlistEntryKind `json:"entryKind"`
	EntryValue string                        `json:"entryValue"`
}
...
func (q *Queries) ListEnabledOauthSigninAllowlistEntries(ctx context.Context) ([]ListEnabledOauthSigninAllowlistEntriesRow, error) {
	rows, err := q.db.QueryContext(ctx, listEnabledOauthSigninAllowlistEntries)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []ListEnabledOauthSigninAllowlistEntriesRow{}
	for rows.Next() {
		var i ListEnabledOauthSigninAllowlistEntriesRow
		if err := rows.Scan(&i.EntryKind, &i.EntryValue); err != nil {
			return nil, err
		}
...
const listOauthSigninAllowlistEntries = `-- name: ListOauthSigninAllowlistEntries :many
SELECT
  a.public_id,
  a.entry_kind,
  a.entry_value,
...
type ListOauthSigninAllowlistEntriesParams struct {
	Limit  int32 `json:"limit"`
	Offset int32 `json:"offset"`
}

type ListOauthSigninAllowlistEntriesRow struct {
	PublicID           types.PublicID                `json:"publicId"`
	EntryKind          OauthSigninAllowlistEntryKind `json:"entryKind"`
	EntryValue         string                        `json:"entryValue"`
	Notes              sql.NullString                `json:"notes"`
...
// admin list.
func (q *Queries) ListOauthSigninAllowlistEntries(ctx context.Context, arg ListOauthSigninAllowlistEntriesParams) ([]ListOauthSigninAllowlistEntriesRow, error) {
	rows, err := q.db.QueryContext(ctx, listOauthSigninAllowlistEntries, arg.Limit, arg.Offset)
	if err != nil {
		return nil, err
	}
	defer rows.Close()
	items := []ListOauthSigninAllowlistEntriesRow{}
	for rows.Next() {
		var i ListOauthSigninAllowlistEntriesRow
		if err := rows.Scan(
			&i.PublicID,
			&i.EntryKind,
			&i.EntryValue,
...
const upsertOauthSigninAllowlistEntry = `-- name: UpsertOauthSigninAllowlistEntry :exec
...
type UpsertOauthSigninAllowlistEntryParams struct {
	PublicID      types.PublicID                `json:"publicId"`
...
func (q *Queries) UpsertOauthSigninAllowlistEntry(ctx context.Context, arg UpsertOauthSigninAllowlistEntryParams) error {
	_, err := q.db.ExecContext(ctx, upsertOauthSigninAllowlistEntry,
		arg.PublicID,
		arg.AddedByUserID,
		arg.EntryKind,
		arg.EntryValue,
...
const withdrawOauthSigninAllowlistEntry = `-- name: WithdrawOauthSigninAllowlistEntry :execrows
...
func (q *Queries) WithdrawOauthSigninAllowlistEntry(ctx context.Context, publicID types.PublicID) (int64, error) {
	result, err := q.db.ExecContext(ctx, withdrawOauthSigninAllowlistEntry, publicID)
	if err != nil {
		return 0, err
	}
