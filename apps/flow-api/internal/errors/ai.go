...
var (
	...
	AiReverseAlreadyReversed = &Spec{Code: "AI.REVERSE.ALREADY_REVERSED", Status: 409, Message: "Event already has a compensating reverse.", Description: "An event can only be reversed once. The compensating reverse event is the canonical undo; further changes require new actions.", UserAction: "View the timeline to see the reversal record.", I18nKey: "errors.ai.reverse.alreadyReversed"}
	// AI.REVERSE.NOT_LLM_ORIGIN — Cannot reverse an event that did not originate from an LLM agent.
	AiReverseNotLlmOrigin = &Spec{Code: "AI.REVERSE.NOT_LLM_ORIGIN", Status: 403, Message: "Cannot reverse an event that did not originate from an LLM agent.", Description: "Only events with actor_agent_id IS NOT NULL may be reversed via the reverse endpoint. User-originated and worker-emitted events are immutable from the user-facing reversal flow.", UserAction: "Edit the source data directly or use the canonical user-facing action to undo it.", I18nKey: "errors.ai.reverse.notLlmOrigin"}
	// AI.REVERSE.TARGET_NOT_FOUND — Event not found in this workspace.
	AiReverseTargetNotFound = &Spec{Code: "AI.REVERSE.TARGET_NOT_FOUND", Status: 404, Message: "Event not found in this workspace.", Description: "The event_public_id was not found among workspace events, or it was deleted via cascade.", UserAction: "Refresh the timeline and retry.", I18nKey: "errors.ai.reverse.targetNotFound"}
