...
type ClaimReminderOccurrenceParams struct {
...
func (q *Queries) ClaimReminderOccurrence(ctx context.Context, arg ClaimReminderOccurrenceParams) (int64, error) {
	result, err := q.db.ExecContext(ctx, claimReminderOccurrence, arg.WorkspaceID, arg.EventID, arg.OccurrenceStart)
	if err != nil {
		return 0, err
	}
...
type ReleaseReminderOccurrenceParams struct {
	EventID         uint32    `json:"-"`
	OccurrenceStart time.Time `json:"occurrenceStart"`
}
...
func (q *Queries) ReleaseReminderOccurrence(ctx context.Context, arg ReleaseReminderOccurrenceParams) error {
	_, err := q.db.ExecContext(ctx, releaseReminderOccurrence, arg.EventID, arg.OccurrenceStart)
	return err
}
