...
type Config struct {
	...
	PublicBaseURL string `env:"NF_FLOW_PUBLIC_URL" envDefault:"http://localhost:8080"`

	// WebBaseURL is where the user is redirected after the OAuth
	// callback handler completes. Defaults to the Vite dev origin.
	WebBaseURL string `env:"NF_FLOW_WEB_URL" envDefault:"http://localhost:5173"`
	...
	GithubClientID     string `env:"NF_FLOW_GITHUB_CLIENT_ID"      envDefault:""`
	GithubClientSecret string `env:"NF_FLOW_GITHUB_CLIENT_SECRET"  envDefault:""`
	SlackClientID      string `env:"NF_FLOW_SLACK_CLIENT_ID"       envDefault:""`
	SlackClientSecret  string `env:"NF_FLOW_SLACK_CLIENT_SECRET"   envDefault:""`
	GoogleClientID     string `env:"NF_FLOW_GOOGLE_CLIENT_ID"      envDefault:""`
	GoogleClientSecret string `env:"NF_FLOW_GOOGLE_CLIENT_SECRET"  envDefault:""`
