// Panic guard tests for nlconstraint constructors.
//
...
// TestNew_PanicsOnNilProvider locks in that nlconstraint.New refuses a
// nil Provider so wiring mistakes surface at boot.
