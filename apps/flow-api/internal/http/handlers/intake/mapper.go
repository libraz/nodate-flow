...
// mapKeysetListRow converts a ListIntakeItemsForWorkspaceKeysetRow to the Record DTO.
func mapKeysetListRow(r generated.ListIntakeItemsForWorkspaceKeysetRow) Record {
	item := Record{
		ID:                   r.PublicID.String(),
		Title:                r.Title,
		Body:                 nullStr(r.Body),
